...
本地 Python 3.14 的 CUDA wheel 不可用，训练在 AutoDL 云 GPU (RTX 5090) 上完成。

## 训练结果

| 指标 | VGG-16 | ResNet-18 |
|------|:------:|:---------:|
| 参数量 | 14,990,922 | 11,173,962 |
| **最佳测试准确率** | **90.72%** | **93.96%** |
| 平均 epoch 耗时 (RTX 5090) | 5.2s | 6.6s |

**ResNet-18 全面优于 VGG-16**：
- 参数少 25%（11.2M vs 15.0M）
- 准确率高 3.2%（93.96% vs 90.72%）
- 速度快（残差连接梯度流动更好，实际收敛更快）
