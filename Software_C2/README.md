...
| 类别 | mAP@50 | Precision | Recall |
|------|:-----:|:---------:|:------:|
| community_person | 0.950 | 0.867 | 0.887 |
| non_community_person | **0.995** | 0.964 | **1.000** |
| electric_bike | 0.284 | 1.000 | 0.000 |

> 核心类别「非社区人员」召回率达到 100%（6/6 全部检出），说明人工修正的 61 个非社区标注有效。
> 电动车类别较弱：验证集仅 2 个样本，且多为误检删除后剩余样本少，召回为 0，属于小样本类别。
